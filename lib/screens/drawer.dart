        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text('Balance'),
              onTap: () {popandNavigate(context: context , route: Balance());},
            ),
            ListTile(
            ...
            ListTile(
              ...
              title: Text('Map'),
              onTap: ()  {popandNavigate(context: context , route: MapScreen());},
            ),
            ListTile(
              leading: Icon(Icons.history),
              title: Text('History'),
              onTap: ()  {
popandNavigate(context: context , route: PaginationDataTable());
